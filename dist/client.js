...
class I18nPlugin extends camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__.PureComponent {
  ...
  componentDidMount() {
    ...
    config.getForPlugin(configKey, 'config').then(config => {
      if (config) {
        ...
        _bpmnjs_i18n_extension__WEBPACK_IMPORTED_MODULE_2__["default"].translateModule.prototype.currentLanguage = function () {
        ...
        subscribe('bpmn.modeler.configure', event => {
          ...
          middlewares.push(this.addModule(_bpmnjs_i18n_extension__WEBPACK_IMPORTED_MODULE_2__["default"]));
        });
        subscribe('dmn.modeler.configure', event => {
          const {
            middlewares
          } = event;
          middlewares.push(this.addDmdModule(_bpmnjs_i18n_extension__WEBPACK_IMPORTED_MODULE_2__["default"]));
        });
      }
    });
  }
  ...
  render() {
    ...
    })), this.state.modalOpen && /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ConfigModal__WEBPACK_IMPORTED_MODULE_3__["default"], {
