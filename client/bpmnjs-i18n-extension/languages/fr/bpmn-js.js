...
export default {
    ...
    'A participant with its process shown inside': 'Un participant dont le processus est affiché à l\'intérieur',
    'A subprocess that completes as a whole, or is compensated': 'Un sous-processus qui s\'achève dans son ensemble ou qui est compensé',
    'A subprocess triggered by an event in its scope': 'Un sous-processus déclenché par un événement dans sa portée',
    'A task done by a person without any tooling or UI': 'Une tâche réalisée par une personne sans outil ni interface',
    ...
    'An unspecified step, often used as a placeholder': 'Une étape non spécifiée, souvent utilisée comme espace réservé',
    ...
    'Calls another process as a reusable subprocess': 'Appelle un autre processus comme sous-processus réutilisable',
    ...
    'Evaluates a business rule, typically a DMN decision': 'Évalue une règle métier, généralement une décision DMN',
    ...
    'Fires on a timer while the activity continues': 'Se déclenche sur une minuterie pendant que l\'activité se poursuit',
    'Follows the path of whichever event occurs first': 'Suit le chemin de l\'événement qui survient en premier',
    'Gateways': 'Passerelles',
    'Groups elements into a subprocess, shown collapsed': 'Regroupe des éléments dans un sous-processus, affiché réduit',
    'Groups elements into a subprocess, shown inline': 'Regroupe des éléments dans un sous-processus, affiché développé',
    'Handles an event that occurs while an activity is active': 'Traite un événement survenant pendant qu\'une activité est active',
    'Immediately ends all active paths in the scope': 'Termine immédiatement tous les chemins actifs de la portée',
    ...
    'Interrupts the activity on a defined timer': 'Interrompt l\'activité selon une minuterie définie',
    'Interrupts the activity on a matching signal': 'Interrompt l\'activité sur un signal correspondant',
    'Interrupts the activity on an escalation': 'Interrompt l\'activité lors d\'une escalade',
    'Interrupts the activity when a condition is met': 'Interrompt l\'activité lorsqu\'une condition est remplie',
    'Interrupts the activity when a message is received': 'Interrompt l\'activité à la réception d\'un message',
    'Interrupts the activity when it throws an error': 'Interrompt l\'activité lorsqu\'elle lève une erreur',
    ...
    'React to something while an activity is running': 'Réagissent à quelque chose pendant l\'exécution d\'une activité',
    'Reacts to a message while the activity continues': 'Réagit à un message pendant que l\'activité se poursuit',
    'Reacts to a signal while the activity continues': 'Réagit à un signal pendant que l\'activité se poursuit',
    'Reacts to an escalation while the activity continues': 'Réagit à une escalade pendant que l\'activité se poursuit',
    ...
    'Route the flow: branch or merge paths': 'Orientent le flux : divisent ou fusionnent les chemins',
    'Routes the token down one path, based on data': 'Oriente le jeton vers un seul chemin, en fonction des données',
    ...
    'Splits the flow into parallel paths, or joins them': 'Divise le flux en chemins parallèles ou les fusionne',
    'Start event': 'Événement de démarrage',
    'Start events': 'Événements de démarrage',
    'Starts an event subprocess on a message, without interrupting': 'Démarre un sous-processus événementiel sur un message, sans interrompre',
    'Starts an event subprocess on a signal, without interrupting': 'Démarre un sous-processus événementiel sur un signal, sans interrompre',
    'Starts an event subprocess on a timer, without interrupting': 'Démarre un sous-processus événementiel sur une minuterie, sans interrompre',
    'Starts an event subprocess on an escalation': 'Démarre un sous-processus événementiel lors d\'une escalade',
    'Starts an event subprocess on an escalation, without interrupting': 'Démarre un sous-processus événementiel lors d\'une escalade, sans interrompre',
    'Starts an event subprocess to handle compensation': 'Démarre un sous-processus événementiel pour gérer la compensation',
    'Starts an event subprocess when a condition is met, without interrupting': 'Démarre un sous-processus événementiel lorsqu\'une condition est remplie, sans interrompre',
    'Starts an event subprocess when an error is thrown': 'Démarre un sous-processus événementiel lorsqu\'une erreur est levée',
    'Starts the process on a defined timer': 'Démarre le processus selon une minuterie définie',
    'Starts the process when a condition is met': 'Démarre le processus lorsqu\'une condition est remplie',
    'Starts the process when a matching signal is broadcast': 'Démarre le processus lorsqu\'un signal correspondant est diffusé',
    'Starts the process when a message is received': 'Démarre le processus à la réception d\'un message',
    ...
    'Takes every outgoing path whose condition is met': 'Emprunte tous les chemins sortants dont la condition est remplie',
    'Tasks': 'Tâches',
    'Terminate end event': 'Événement de fin de terminaison',
    'The default path, taken when no other path condition is met': 'Le chemin par défaut, emprunté lorsqu\'aucune autre condition n\'est remplie',
    ...
    'Triggers compensation of completed activities': 'Déclenche la compensation des activités terminées',
    'User task': 'Tâche utilisateur',
    'Wait for something to happen before continuing': 'Attendent qu\'un événement survienne avant de continuer',
