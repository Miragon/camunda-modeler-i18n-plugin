...
const translations: Record<string, string> = {
    ...
    'Editing not supported for set expression language':
        'Bearbeitung für festgelegte Ausdruckssprache nicht unterstützt',
    ...
    'No overlap is possible and all rules are disjoint. Only a single rule can be matched':
        'Keine Überschneidung möglich, alle Regeln sind disjunkt. Es kann nur eine einzige Regel zutreffen',
    ...
    'Version tag by which this decision can be referenced.':
        'Versions-Tag, über das diese Entscheidung referenziert werden kann.',
