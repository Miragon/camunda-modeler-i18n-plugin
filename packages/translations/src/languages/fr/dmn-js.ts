...
const translations: Record<string, string> = {
    ...
    'Editing not supported for set expression language':
        "La modification n'est pas prise en charge pour le langage d'expression défini",
    ...
    'No overlap is possible and all rules are disjoint. Only a single rule can be matched':
        "Aucun chevauchement n'est possible et toutes les règles sont disjointes. Une seule règle peut correspondre",
    ...
    'Version tag by which this decision can be referenced.':
        'Étiquette de version permettant de référencer cette décision.',
