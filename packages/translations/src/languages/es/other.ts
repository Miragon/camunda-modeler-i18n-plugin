...
const translations: Record<string, string> = {
    'A JSON object — each key represents a variable produced by this element.':
        'Un objeto JSON — cada clave representa una variable producida por este elemento.',
    ...
    'flow elements must be children of pools/participants':
        'Los elementos de flujo deben colocarse dentro de pools/participantes',
    Foo: 'Foo',
    Gateway: 'Compuerta',
    Groovy: 'Groovy',
    ID: 'ID',
    ...
    'The template applied was not found. Therefore, its properties cannot be shown. Unlink to access the data.':
        'No se encontró la plantilla aplicada. Por lo tanto, sus propiedades no se pueden mostrar. Desvincule para acceder a los datos.',
    'This maps to the decision definition key.':
        'Esto se asigna a la clave de definición de decisión.',
    'This maps to the process definition key.':
        'Esto se asigna a la clave de definición del proceso.',
