...
const translations: Record<string, string> = {
    ...
    'No overlap is possible and all rules are disjoint. Only a single rule can be matched':
        'No es posible el solapamiento y todas las reglas son disjuntas. Solo se puede aplicar una única regla',
    ...
    'Version tag by which this decision can be referenced.':
        'Etiqueta de versión por la que se puede referenciar esta decisión.',
    'View DRD': 'Ver DRD',
    When: 'Cuando',
    Yes: 'Sí',
    value: 'valor',
