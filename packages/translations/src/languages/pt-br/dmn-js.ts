...
const translations: Record<string, string> = {
    ...
    'No overlap is possible and all rules are disjoint. Only a single rule can be matched':
        'Nenhuma sobreposição é possível e todas as regras são disjuntas. Apenas uma única regra pode corresponder',
    ...
    'Version tag by which this decision can be referenced.':
        'Tag de versão pela qual esta decisão pode ser referenciada.',
