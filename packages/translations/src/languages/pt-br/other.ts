...
const translations: Record<string, string> = {
    'A JSON object — each key represents a variable produced by this element.':
        'Um objeto JSON — cada chave representa uma variável produzida por este elemento.',
    ...
    'Process variable name must not be empty.':
        'O nome da variável de processo não pode estar vazio.',
    'Process variable name must not contain spaces.':
        'O nome da variável de processo não pode conter espaços.',
    Python: 'Python',
    Question: 'Pergunta',
    ...
    'The template applied was not found. Therefore, its properties cannot be shown. Unlink to access the data.':
        'O modelo aplicado não foi encontrado. Por isso, suas propriedades não podem ser exibidas. Desvincule para acessar os dados.',
